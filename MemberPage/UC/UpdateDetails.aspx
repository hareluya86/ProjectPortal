...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <asp:UpdateProgress runat="server" ID="UpdateProgress3" AssociatedUpdatePanelID="UpdateUCDetailPanel">
                <ProgressTemplate>
                    <div class="overlay">
            ...
            <asp:UpdatePanel runat="server" ID="UpdateUCDetailPanel" UpdateMode="Conditional">
                <ContentTemplate>
                    <!--main info-->
                    <div class="row">
                        <!--Company Contacts-->
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-offset-8" style="margin-top: 5px; text-align: right; vertical-align: middle;">
